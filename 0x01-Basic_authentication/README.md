...
12. Improve the method def extract_user_credentials(self, decoded_base64_authorization_header) to allow password with :.
...
13. Improve def require_auth(self, path, excluded_paths) by allowing * at the end of excluded paths.
