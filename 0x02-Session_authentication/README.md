...
9. Actually you have 2 authentication systems:
...
10. Since the beginning, all Session IDs are stored in memory. It means, if your application stops, all Session IDs are lost.
